      ...
      >
        ...
        <div className="flex shrink-0 gap-2">
          <button
            ...
            title="Decline (Esc)"
            className="flex h-9 w-9 items-center justify-center rounded-full bg-error text-text-bright transition-opacity hover:opacity-90"
          >
          ...
          <button
            ...
            title="Accept"
            className="flex h-9 w-9 items-center justify-center rounded-full bg-success text-bg-primary transition-opacity hover:opacity-90"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
