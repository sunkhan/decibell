        ...
        {sortedConversations.map((conv) => {
          ...
          return (
            <button
              ...
              className={`relative shrink-0 cursor-pointer rounded-md transition-all duration-150 hover:-translate-y-0.5 ${
            ...
            >
              ...
              {conv.unreadCount > 0 && (
                <div
                  className="absolute -top-1 -right-1 flex h-[18px] w-[18px] items-center justify-center rounded-full border-[2px] border-bg-darkest bg-error text-[10px] font-semibold leading-none text-white"
