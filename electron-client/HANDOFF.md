...
0.7.12 is the current release (0.7.11 the server live-test fixes + Win10 borderless capture; 0.7.12 the DXGI pacing + back-to-stream fixes). It carries **four proto additions** —
