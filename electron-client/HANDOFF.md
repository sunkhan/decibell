...
0.7.13 is the current release (0.7.12 the DXGI pacing + back-to-stream fixes; 0.7.13 GPU cursor compositing + fps pacing on every capture path). It carries **four proto additions** —
