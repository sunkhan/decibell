...
0.7.9 is the current release (0.7.8 was the first build with calls; 0.7.9 carries the stage redesign + the fixes from the first live test). It carries **four proto additions** —
