...
0.7.10 is the current release (0.7.8 was the first build with calls; 0.7.9 the stage redesign; 0.7.10 the second live-test fixes + resizable stage). It carries **four proto additions** —
