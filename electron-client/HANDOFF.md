...
0.7.11 is the current release (0.7.10 the second call live-test fixes; 0.7.11 the server live-test fixes + Win10 borderless capture). It carries **four proto additions** —
