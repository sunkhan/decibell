...
server management + moderation (batch 17), relay / keep-alive / FTS (batch 18) and
Theme A — Ed25519 JWTs / uid bans (batch 19) (see `docs/reviews/2026-08-21-community-server-review.md`).
